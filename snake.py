...
snake_head.speed(0)
snake_head.shape("circle")  # Change shape to circle
snake_head.color("#27AE60")  # Dark green color for the snake head
snake_head.penup()
snake_head.goto(0, 0)
...
snake_food.color("#FFD700")  # Gold color for snake food
snake_food.penup()
...
while True:
    ...
    if snake_head.distance(snake_food) < 20:
        ...
        if len(segments) % 2 == 0:
            new_segment.color("#E74C3C")  # Classy red
        else:
            new_segment.color("#8E44AD")  # Classy purple
        new_segment.penup()
